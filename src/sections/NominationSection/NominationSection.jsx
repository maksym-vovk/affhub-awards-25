...
function NominationSection() {
    ...
    const nominations = useMemo(() => {
        const defaultNominations = t('nominations', { returnObjects: true }).list || [];
        return updateNominationState(defaultNominations, statisticsQuery.data, usersVotesQuery.data);
    }, [t, statisticsQuery.data, usersVotesQuery.data]);
